...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/LeoLuis601/LeoLuis601.git\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1:35m"
https://github.com/LeoLuis601/LeoLuis601.git
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} Bot Luxury${b}: "
	read opcion
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://chat.whatsapp.com/DkLKhXrTKsI3w4zVFkj40X &>> /dev/null
